defmodule AdventOfCode.Day23 do
  ...
  def find_solution_search(queue) do
    ...
    if is_done(graph) do
      ...
      |> Enum.reduce(queue, fn {start_room, next_room, count}, queue ->
        ...
        PriorityQueue.put(queue, cost + count * energy(start_pod), {new_graph, prev_moves ++ [{start_room, next_room, count}]})
      end)
      |> find_solution_search()
    end
  end
  ...
  def is_done(graph) do
    ...
    poda1 == "A" and poda2 == "A" and (poda3 == "A" or poda3 == nil) and (poda4 == "A" or poda4 == nil) and
    podb1 == "B" and podb2 == "B" and (podb3 == "B" or podb3 == nil) and (podb4 == "B" or podb4 == nil) and
    podc1 == "C" and podc2 == "C" and (podc3 == "C" or podc3 == nil) and (podc4 == "C" or podc4 == nil) and
    podd1 == "D" and podd2 == "D" and (podd3 == "D" or podd3 == nil) and (podd4 == "D" or podd4 == nil)
  end

  def valid_moves(graph) do
    # Find all valid adjacent nodes
    moves = Enum.reduce(graph, [], fn {room, {pod, _}}, moves ->
      case pod do
        "" -> moves
        _ ->
    ...
    |> Enum.reduce([], fn {start_room, steps}, flattened_moves ->
      flattened_moves ++ Enum.reduce(steps, [], fn {next_room, count}, flattened_steps ->
    ...
    best_move = Enum.find(moves, fn {_, next_room, _} ->
  ...
  def traverse_empty_rooms(graph, room, pod) do
    ...
    case pod do
      "A" ->
        ...
        case room do
          "A4" -> {[], [], []}
          "A3" -> if poda4 == "A" or poda4 == nil, do: {[], [], []}, else: traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
          "A2" -> if (poda4 == "A" or poda4 == nil) and (poda3 == "A" or poda3 == nil), do: {[], [], []}, else: traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
          "A1" -> if (poda4 == "A" or poda4 == nil) and (poda3 == "A" or poda3 == nil) and poda2 == "A", do: {[], [], []}, else: traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
          _ -> traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
        end
      "B" ->
        {podb2, _} = Map.get(graph, "B2")
        {podb3, _} = Map.get(graph, "B3", {nil, nil})
        ...
        case room do
          "B4" -> {[], [], []}
          "B3" -> if podb4 == "B" or podb4 == nil, do: {[], [], []}, else: traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
          "B2" -> if (podb4 == "B" or podb4 == nil) and (podb3 == "B" or podb3 == nil), do: {[], [], []}, else: traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
          "B1" -> if (podb4 == "B" or podb4 == nil) and (podb3 == "B" or podb3 == nil) and podb2 == "B", do: {[], [], []}, else: traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
          _ -> traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
        end
      "C" ->
        {podc2, _} = Map.get(graph, "C2")
        ...
        case room do
          "C4" -> {[], [], []}
          "C3" -> if podc4 == "C" or podc4 == nil, do: {[], [], []}, else: traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
          "C2" -> if (podc4 == "C" or podc4 == nil) and (podc3 == "C" or podc3 == nil), do: {[], [], []}, else: traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
          "C1" -> if (podc4 == "C" or podc4 == nil) and (podc3 == "C" or podc3 == nil) and podc2 == "C", do: {[], [], []}, else: traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
          _ -> traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
        end
      "D" ->
        {podd2, _} = Map.get(graph, "D2")
        ...
        case room do
          "D4" -> {[], [], []}
          "D3" -> if podd4 == "D" or podd4 == nil, do: {[], [], []}, else: traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
          "D2" -> if (podd4 == "D" or podd4 == nil) and (podd3 == "D" or podd3 == nil), do: {[], [], []}, else: traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
          "D1" -> if (podd4 == "D" or podd4 == nil) and (podd3 == "D" or podd3 == nil) and podd2 == "D", do: {[], [], []}, else: traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
          _ -> traverse_empty_rooms(graph, room, pod, room_type(room), [room], 0)
        end
    end
  end
  ...
  def traverse_empty_rooms(graph, room, pod, room_type, visited, curr_count) do
    ...
    # Find all valid adjacent nodes
    {moves, rooms, visited} = Enum.reduce(connected_rooms, {[], [], visited}, fn {next_room, count}, {moves, rooms, visited} ->
        ...
        case pod_in_room do
          "" ->
            case room_type == :hallway and room_type(next_room) == :hallway do
              true -> {moves, rooms ++ [{next_room, curr_count + count}], visited ++ [next_room]}
              false ->
                if can_pod_enter_room(graph, pod, next_room) do
                  {moves ++ [{next_room, curr_count + count}], rooms ++ [{next_room, curr_count + count}], visited ++ [next_room]}
                else
                  {moves, rooms ++ [{next_room, curr_count + count}], visited ++ [next_room]}
                end
            end
          _ -> {moves, rooms, visited ++ [next_room]}
        end
      end
    end)
    # Find subsequent non-adjacent nodes
    {further_moves, further_rooms, further_visited} = Enum.reduce(rooms, {[], [], visited}, fn {next_room, count}, {moves, rooms, visited} ->
      {new_moves, new_rooms, new_visited} = traverse_empty_rooms(graph, next_room, pod, room_type, visited, count)
  ...
  def can_pod_enter_room(graph, pod, room) do
    case pod do
      "A" -> case room do
        r when r in ["B1", "B2", "B3", "B4", "C1", "C2", "C3", "C4", "D1", "D2", "D3", "D4"] -> false
        "A3" ->
          {poda4, _} = Map.get(graph, "A4", {nil, nil})
      ...
      "B" -> case room do
        r when r in ["A1", "A2", "A3", "A4", "C1", "C2", "C3", "C4", "D1", "D2", "D3", "D4"] -> false
        "B3" ->
          {podb4, _} = Map.get(graph, "B4", {nil, nil})
      ...
      "C" -> case room do
        r when r in ["A1", "A2", "A3", "A4", "B1", "B2", "B3", "B4", "D1", "D2", "D3", "D4"] -> false
        "C3" ->
          {podc4, _} = Map.get(graph, "C4", {nil, nil})
      ...
      "D" -> case room do
        r when r in ["A1", "A2", "A3", "A4", "B1", "B2", "B3", "B4", "C1", "C2", "C3", "C4"] -> false
        "D3" ->
          {podd4, _} = Map.get(graph, "D4", {nil, nil})
  ...
  def room_type(room) do
    case room do
      r when r in ["A1", "A2", "A3", "A4", "B1", "B2", "B3", "B4", "C1", "C2", "C3", "C4", "D1", "D2", "D3", "D4"] -> :room
      _ -> :hallway
    end
  end
